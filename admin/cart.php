...
// $sql = "SELECT `id`, `name`, `catid`, `price`, `thumb`, `description` FROM `products` order by id ASC"
		...
		<div class="col-lg-3 col-md-3 col-sm-12">
			...
			<form>
				<div class="card">
					...
					<div class="card-body">
						 <img src="<?php echo
					 $product['thumb'];  ?>" alt="phone" class="img-fluid mb-2" >

					 <h6> &#8377; <?php echo $product['price'];  ?><span> (<?php echo $product['discount'];  ?>% o\ff) </span> </h6>
